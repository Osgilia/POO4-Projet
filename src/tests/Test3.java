...
public class Test3 {
    ...
    public static void main(String[] args) {
        ...
        //Abilitation des techniciens à travailler sur certains type de machine
        t1.addPotentialInstallation(m1);
        t2.addPotentialInstallation(m2);
        
        //Affectation des Machines, Véhicules et Points à l'instance
        instance.addMachine(m1);
        instance.addMachine(m2);
        instance.addVehicle(v1);
        instance.addVehicle(v2);
        instance.addPoint(d);
        instance.addPoint(c1);
        instance.addPoint(c2);
        instance.addPoint(c3);
